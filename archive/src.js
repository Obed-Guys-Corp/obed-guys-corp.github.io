...
Promise.all([
  fetch("/archive/content/beta.json?v1").then((res) => res.text()),
  fetch("/archive/content/steam.json?v1").then((res) => res.text()),
  fetch("/archive/content/epic.json?v1").then((res) => res.text()),
  fetch("/archive/content/android.json?v1").then((res) => res.text()),
  fetch("/archive/content/strings.json?v1").then((res) => res.json()),
])
